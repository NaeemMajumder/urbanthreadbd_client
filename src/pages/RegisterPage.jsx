...
const RegisterPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.error(
        err.response?.data?.message || "Registration failed। আবার try করো।",
      );
    } finally {
      setLoading(false);
    }
      ...
      >
        <div
          style={{
            ...
            height: "500px",
            background:
              "radial-gradient(circle, rgba(170,255,0,0.05) 0%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
        ...
        >
                ...
                {[1, 2, 3].map((i) => (
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: "2px",
                      background:
                        i <= strength.level ? strength.color : "#1A1A1A",
          ...
          <div style={{ marginBottom: "28px" }}>
            ...
            {form.confirmPassword && form.password !== form.confirmPassword && (
              <p
                style={{ color: "#FF4444", fontSize: "11px", marginTop: "4px" }}
              >
